...
Codex CLI supports Chinese model providers via the OpenAI Chat Completions API. The CLI automatically detects these providers and handles protocol conversion from the internal Responses API format.
